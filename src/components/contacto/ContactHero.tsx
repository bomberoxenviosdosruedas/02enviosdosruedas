        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-md -rotate-1 shadow-glow-yellow">
              <span className="relative flex h-3 w-3 shrink-0">
                ...
                <span className="relative inline-flex rounded-full h-3 w-3 bg-[#FFEC01]" />
              </span>
              <span className="font-subheading text-xs sm:text-[13px] font-bold uppercase tracking-[0.08em] text-[#FFEC01]">
            ...
            <h1 className="font-display uppercase tracking-tight leading-[0.9] text-balance text-4xl sm:text-[2.9rem] lg:text-6xl xl:text-[4.8rem]">
              ...
              <span className="inline-block bg-[#FFEC01] text-[#0950F6] px-4 py-1.5 -rotate-1 rounded-xl shadow-glow-yellow my-2">
                ASESORAMIENTO
              </span>
              <span className="block text-white/90 text-[0.45em] sm:text-[0.4em] font-sans font-bold tracking-normal">
                MAR DEL PLATA
              </span>
            </h1>
            ...
            <p className="font-sans leading-relaxed text-white/90 text-[17px] sm:text-lg lg:text-xl max-w-2xl mx-auto lg:mx-0 font-light">
              ...
              <span className="text-[#FFEC01] font-semibold">cero tercerización</span> y respuesta inmediata.
            </p>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-6 sm:gap-8 pt-6 border-t border-white/15">
              <div className="grid gap-1 text-center lg:text-left">
                <span className="font-subheading text-[11px] uppercase tracking-wider text-[#FFEC01] font-bold">Oficina Central</span>
                <span className="font-mono text-[13px] sm:text-sm font-bold text-white tabular-nums flex items-center gap-1.5 justify-center lg:justify-start"><MapPin className="w-3.5 h-3.5 text-[#FFEC01]" />Friuli 1972, MDQ</span>
              </div>
              <div className="grid gap-1 text-center lg:text-left">
                <span className="font-subheading text-[11px] uppercase tracking-wider text-[#FFEC01] font-bold">Operación</span>
                <span className="font-mono text-[13px] sm:text-sm font-bold text-white tabular-nums flex items-center gap-1.5 justify-center lg:justify-start"><Clock className="w-3.5 h-3.5 text-[#FFEC01]" />Lun a Sáb · 2026</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col items-center w-full">
            <div className="relative w-full max-w-lg space-y-4">
              <div className="relative z-10 rounded-xl bg-white border-2 border-[#D6E4FE] p-3 shadow-2xl">
                <div className="bg-[#E6EEFE]/60 rounded-lg p-2">
                ...
                <div className="mt-3 flex items-center justify-between font-mono text-[11px] uppercase tracking-wider text-[#0950F6]/80 tabular-nums">
                  <span className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-[#0950F6] animate-pulse" />Friuli 1972 · MDQ</span>
