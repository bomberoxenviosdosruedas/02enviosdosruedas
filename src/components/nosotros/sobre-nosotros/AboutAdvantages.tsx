      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <motion.div
            ...
            className="lg:col-span-7 bg-white p-8 rounded-3xl border-2 border-brand-blue shadow-[6px_6px_0px_#0636A5] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_#0636A5] transition-all duration-300 flex flex-col justify-between"
          >
          ...
          <motion.div
            ...
            className="lg:col-span-5 bg-brand-blue text-white p-8 rounded-3xl border-2 border-brand-yellow shadow-[6px_6px_0px_#FFEC01] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_#FFEC01] transition-all duration-300 flex flex-col justify-between"
          >
            <div className="space-y-5">
          ...
          <motion.div
            ...
            className="lg:col-span-12 bg-white p-8 rounded-3xl border-2 border-brand-blue shadow-[6px_6px_0px_#0636A5] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_#0636A5] transition-all duration-300 flex flex-col md:flex-row md:items-center justify-between gap-6"
          >
