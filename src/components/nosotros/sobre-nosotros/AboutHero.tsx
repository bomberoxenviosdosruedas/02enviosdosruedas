...
export default function AboutHero() {
  ...
  return (
    <section 
      id="about-hero" 
      className="relative min-h-[85vh] flex items-center justify-center pt-32 pb-20 overflow-hidden bg-gradient-to-br from-[#0636A5] to-[#0742CA] text-white border-b border-brand-blue-100/10"
    >
        ...
        >
          ...
          <div className="lg:col-span-7 text-center lg:text-left space-y-6">
            ...
            >
              ...
              <span className="text-brand-yellow-500 drop-shadow-[0_2px_10px_rgba(255,236,1,0.25)]">ÚLTIMA MILLA</span>
            </motion.h1>
