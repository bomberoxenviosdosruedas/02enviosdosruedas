...
export default function AboutHero() {
  ...
  return (
    <section 
      id="about-hero" 
      className="relative min-h-[85vh] flex items-center justify-center pt-32 pb-20 overflow-hidden bg-brand-blue-700 text-white border-b border-brand-blue-100/10"
    >
