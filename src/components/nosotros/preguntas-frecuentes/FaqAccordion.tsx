                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <h4 className={`text-base sm:text-lg font-sans font-semibold leading-tight transition-colors ${isExpanded ? 'text-brand-blue-700' : 'text-brand-blue-700/80 group-hover:text-brand-blue-700'}`}>
                          {item.question}
                        </h4>
                      </div>
