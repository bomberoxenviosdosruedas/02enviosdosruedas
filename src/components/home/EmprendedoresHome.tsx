...
// Typography: Outfit / Display: Anton
// GSAP: Hover Physics + Scrubbing Text Reveals
// Components: Pristine Gapless Bento Grid + Inline Typography Images + Infinite Marquee
...
export default function EmprendedoresHome() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-brand-yellow-500/5 rounded-full blur-[150px] pointer-events-none animate-pulse" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">

        {/* Section Header - Editorial Split with Inline Typography Image */}
        <div className="max-w-6xl mb-24 space-y-6 text-left">
        ...
        {/* Mathematically perfect 12-column gapless grid: Card 1 (col-span-7, row-span-2) meets Card 2 (col-span-5, row-span-1) & Card 3 (col-span-5, row-span-1) */}
        <div
        ...
        >
          ...
          <div className="lg:col-span-7 lg:row-span-2 double-bezel-outer p-2 rounded-2xl bg-brand-blue-50/5 border border-brand-blue-500/20 hover:border-brand-yellow/30 hover:bg-brand-blue-50/10 hover:shadow-antigravity-deep transition-all duration-500 group overflow-hidden flex flex-col">
            <div className="double-bezel-inner bg-brand-blue-700/60 p-6 sm:p-8 rounded-xl border border-brand-blue-500/20 shadow-inner flex flex-col justify-between h-full relative overflow-hidden text-left flex-1">
              ...
              <div className="absolute right-4 bottom-4 text-white opacity-[0.03] pointer-events-none select-none transition-transform duration-700 group-hover:scale-110 group-hover:rotate-3">
              ...
              <div className="pt-6 mt-6 border-t border-brand-blue-500/20 relative z-10 flex justify-end">
                ...
                >
                  ...
                  <span className="cta-nested-icon bg-brand-blue/10 w-6 h-6 rounded-full flex items-center justify-center transition-transform group-hover:translate-x-1">→</span>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 lg:row-span-1 double-bezel-outer p-2 rounded-2xl bg-brand-yellow-500/10 border border-brand-yellow-500/20 hover:border-brand-blue/30 hover:bg-brand-yellow-500/15 hover:shadow-[0_20px_40px_-15px_rgba(255,236,1,0.15)] transition-all duration-500 group overflow-hidden flex flex-col">
            <div className="double-bezel-inner bg-gradient-to-br from-brand-yellow-500 to-brand-yellow-400 p-6 sm:p-8 rounded-xl border border-brand-yellow-500/20 shadow-sm flex flex-col justify-between h-full relative overflow-hidden text-left text-brand-blue-900 flex-1">
              ...
              {/* Subtle Radial Glow */}
              <div className="absolute bottom-0 right-0 w-36 h-36 rounded-full bg-white/20 blur-2xl pointer-events-none" />

              {/* Watermark Background Icon */}
              <div className="absolute right-4 bottom-4 text-brand-blue opacity-[0.04] pointer-events-none select-none transition-transform duration-700 group-hover:scale-110 group-hover:rotate-3">
              ...
              <div className="space-y-4 relative z-10">
                ...
                <div className="space-y-1">
                  <h3 className="text-xl sm:text-2xl font-display uppercase tracking-tight text-brand-blue leading-none group-hover:text-brand-blue-950 transition-colors duration-300">
                    Envíos Flex Meli
                  </h3>
              ...
              <div className="pt-4 mt-4 border-t border-brand-blue/10 relative z-10 flex justify-end">
                ...
                >
                  ...
                  <span className="cta-nested-icon bg-white/10 w-6 h-6 rounded-full flex items-center justify-center transition-transform group-hover:translate-x-1">→</span>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 lg:row-span-1 double-bezel-outer p-2 rounded-2xl bg-brand-blue-50/80 border border-brand-blue-100 hover:border-brand-blue-300 hover:shadow-antigravity-deep transition-all duration-500 group overflow-hidden flex flex-col">
            <div className="double-bezel-inner bg-white p-6 sm:p-8 rounded-xl border border-brand-blue-50/50 shadow-sm flex flex-col justify-between h-full relative overflow-hidden text-left text-brand-ink flex-1">
              ...
              {/* Subtle Radial Glow */}
              <div className="absolute bottom-0 right-0 w-36 h-36 rounded-full bg-brand-blue-500/5 blur-2xl pointer-events-none" />

              {/* Watermark Background Icon */}
              <div className="absolute right-4 bottom-4 text-brand-blue opacity-[0.02] pointer-events-none select-none transition-transform duration-700 group-hover:scale-110 group-hover:rotate-3">
              ...
              <div className="space-y-4 relative z-10">
                ...
                <div className="space-y-1">
                  <h3 className="text-xl sm:text-2xl font-display uppercase tracking-tight text-brand-blue group-hover:text-brand-blue-900 transition-colors duration-300">
        ...
        {/* Infinite Marquee of Local Partners */}
        <div className="mt-24 pt-12 border-t border-brand-blue-500/10">
      ...
      {/* Local marquee stylesheet injection */}
      <style>{`
        @keyframes marquee {
