      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <motion.div
            ...
            className="lg:col-span-7 double-bezel-outer bg-brand-blue-100/80 hover:shadow-[4px_4px_0px_var(--color-brand-yellow)] border-2 border-brand-yellow transition-all duration-300 flex flex-col group cursor-pointer"
          >
            <div className="double-bezel-inner bg-white p-8 flex flex-col justify-between h-full border border-brand-blue-50 space-y-6">
              <div className="space-y-6">
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-xs font-bold tracking-widest bg-brand-blue-50 text-brand-blue-500 px-3 py-1 rounded-full uppercase font-subheading border border-brand-blue-100">
                    EMPRENDEDORES
                  </span>
                </div>
                ...
                <ul className="space-y-2.5 pt-2">
                  {['Soporte dedicado', 'Entregas contrareembolso sin cargo extra', 'Entregas en tiempo y forma'].map((feat) => (
                    <li key={feat} className="flex items-center gap-2 text-xs text-brand-blue-500 font-sans group-hover:text-brand-ink transition-colors">
          ...
          <motion.div
            ...
            className="lg:col-span-5 double-bezel-outer bg-brand-blue-100/80 hover:shadow-[4px_4px_0px_var(--color-brand-yellow)] border-2 border-brand-yellow transition-all duration-300 flex flex-col group cursor-pointer"
          >
            <div className="double-bezel-inner bg-white p-8 flex flex-col justify-between h-full border border-brand-blue-50 space-y-6">
              <div className="space-y-6">
                <div className="flex justify-between items-start">
          ...
          >
            <div className="double-bezel-inner bg-white p-8 sm:p-10 border border-brand-blue-50">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                <div className="md:col-span-7 space-y-4">
                  ...
                  <h3 className="text-3xl font-display uppercase tracking-tight text-brand-blue group-hover:text-brand-blue transition-colors">
                ...
                <div className="md:col-span-5 space-y-6 md:border-l md:border-brand-blue-200 md:pl-8">
                  <ul className="space-y-3">
                    {['Soporte dedicado', 'Entregas contrareembolso sin cargo extra', 'Entregas en tiempo y forma'].map((feat) => (
                      <li key={feat} className="flex items-center gap-2.5 text-xs sm:text-sm text-brand-blue-500 font-sans group-hover:text-brand-ink transition-colors">
                  ...
                  <div className="pt-2">
                    <Link
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-brand-blue hover:text-brand-yellow transition-colors active:scale-[0.98] active:translate-y-[1px]"
                    >
