    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-12 lg:py-16">
        <div className="space-y-6">
          ...
          {/* Title - matches design spec: "Almacenamiento y Fulfillment para PyMEs" with yellow highlight */}
          <motion.h1
          ...
          >
            Almacenamiento y <span className="text-brand-yellow-500">Fulfillment</span> para PyMEs
          </motion.h1>
          ...
          >
            Solución integral de almacenamiento, picking, packing y fulfillment para PyMEs y e-commerce en Mar del Plata. Depósitos propios en la ciudad.
          </motion.p>
