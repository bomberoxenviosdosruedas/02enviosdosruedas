          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-4 flex justify-start lg:justify-end">
              <a
                ...
                className="bg-brand-blue hover:bg-brand-blue/95 border-2 border-brand-blue text-brand-yellow font-subheading tracking-wider text-base uppercase px-8 py-4 rounded-xl shadow-[4px_4px_0px_#D8CA00] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_#D8CA00] transition-all duration-200 flex items-center justify-center gap-2.5 font-bold w-full sm:w-auto"
              >
