        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full text-xs sm:text-sm font-subheading uppercase tracking-wider bg-brand-blue-700/90 text-brand-yellow-500 border-2 border-brand-yellow-500/50 -rotate-1 shadow-glow-yellow backdrop-blur-md">
              <Zap className="h-4 w-4 text-brand-yellow-500 shrink-0 fill-current" />
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
              ...
              <div className="pt-2 sm:pt-0 w-full sm:w-auto">
                <CTANestedPill
                  ...
                  variant="outline"
                  className="w-full sm:w-auto border border-brand-blue-100"
                >
                  Calcular Ahora
                </CTANestedPill>
              </div>
          ...
          >
            ...
            <div className="p-2.5 sm:p-3 rounded-2xl sm:rounded-3xl bg-brand-blue-50/20 border border-brand-blue-100/40 shadow-2xl backdrop-blur-md">
              {/* Inner Midnight Card */}
              <div className="bg-brand-blue-700 rounded-xl p-6 sm:p-8 text-white border border-white/20 shadow-lg space-y-6">
                ...
                <div className="flex items-start justify-between border-b border-white/15 pb-4">
                  <div>
                    ...
                    <p className="font-subheading text-2xs sm:text-xs uppercase tracking-widest text-brand-yellow-500 mt-1">
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-2">
                      <span className="font-subheading text-sm uppercase tracking-wider text-white">
                        TARIFA FINAL
                      </span>
                ...
                <div className="pt-3 flex justify-center">
                  <span className="px-4 py-1.5 rounded-full border border-brand-yellow-500/40 bg-brand-yellow-500/10 text-brand-yellow-500 font-subheading text-2xs uppercase tracking-wider shadow-sm">
