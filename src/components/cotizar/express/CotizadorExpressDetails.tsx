  ...
  return (
    <div id="cotizador-express-details" className="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-12">
      ...
      <div className="lg:col-span-7">
        <DoubleBezelCard>
          <div className="bg-[#0950F6] p-6 sm:p-8 rounded-[20px] border border-white/20 space-y-6 text-white relative overflow-hidden">
            {/* Visual Watermark */}
            <Zap
              ...
              {features.map((feat, idx) => {
                ...
                return (
                  <div key={idx} className="flex gap-4 items-start">
                    <div className="p-3 bg-white/10 text-[#FFEC01] border border-white/20 rounded-xl shrink-0">
      ...
      <div className="lg:col-span-5">
        <DoubleBezelCard>
          <div className="bg-[#0950F6] p-6 sm:p-8 rounded-[20px] border border-white/20 space-y-6 flex flex-col justify-between h-full text-white relative overflow-hidden">
            {/* Visual Watermark */}
            <Shield
              className="absolute -bottom-8 -right-8 w-56 h-56 text-white/[0.04] pointer-events-none"
              aria-hidden="true"
            ...
            <div className="relative z-10">
              <h3 className="text-xl font-subheading uppercase tracking-wider text-[#FFEC01] font-bold border-b border-white/15 pb-3">
              ...
              <div className="space-y-3.5 text-xs sm:text-sm text-white/85 font-sans leading-relaxed mt-4">
                <div className="flex items-start gap-2.5">
                  <Scale className="h-4 w-4 text-[#FFEC01] shrink-0 mt-0.5" />
                  <p>
                    <strong className="text-white">Capacidad Máxima:</strong> Hasta <span className="font-mono text-[#FFEC01] font-bold tabular-nums">15 kg</span> por viaje en caja / mochila de moto.
                  </p>
                </div>

                <div className="flex items-start gap-2.5">
                  <PackageCheck className="h-4 w-4 text-[#FFEC01] shrink-0 mt-0.5" />
                  <p>
                    <strong className="text-white">Dimensiones:</strong> Bultos de hasta <span className="font-mono text-[#FFEC01] font-bold tabular-nums">40 × 40 cm</span> entran en tarifa estándar.
                  </p>
                </div>

                <div className="flex items-start gap-2.5">
                  <Clock className="h-4 w-4 text-[#FFEC01] shrink-0 mt-0.5" />
                  <p>
