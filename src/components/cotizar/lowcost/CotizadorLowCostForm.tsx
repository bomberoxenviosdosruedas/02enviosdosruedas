...
💵 *Tarifa LowCost 2026:* ${priceText}`;
  ...
  return (
    <section id="cotizador-lowcost-form" aria-label="Cotizador LowCost" className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
      ...
      <aside aria-label="Mapa interactivo y cobertura LowCost" className="lg:col-span-5 min-h-[360px] lg:min-h-full rounded-[28px] sm:rounded-[30px] bg-white/10 backdrop-blur-md border border-white/20 p-2.5 shadow-xl transition-all duration-300">
