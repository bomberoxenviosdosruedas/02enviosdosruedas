            ...
            <div className="relative z-10">
              ...
              <div className="space-y-3.5 text-xs sm:text-sm text-white/85 font-sans leading-relaxed mt-4">
                <div className="flex items-start gap-2.5">
                  <Calendar className="h-4 w-4 text-[#FFEC01] shrink-0 mt-0.5" />
                  <p>
                    <strong className="text-white">Horario de Corte:</strong> Pedidos ingresados antes de las <span className="font-mono text-[#FFEC01] font-bold tabular-nums">13:00 hs</span> se entregan en la tarde del mismo día.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  <Truck className="h-4 w-4 text-[#FFEC01] shrink-0 mt-0.5" />
                  <p>
