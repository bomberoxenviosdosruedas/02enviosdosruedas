...
export default function CotizadorLowCostHelp() {
  return (
    <div
      ...
      className="relative overflow-hidden rounded-[28px] sm:rounded-[30px] p-6 sm:p-10 mt-12 bg-brand-blue-900 text-white border border-white/20 shadow-2xl"
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row justify-between items-center gap-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3.5 w-full lg:w-auto justify-center shrink-0">
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            href="/contacto"
            className="group min-h-[52px] inline-flex items-center justify-between bg-white hover:bg-white/90 text-brand-blue-700 font-subheading font-bold tracking-wider text-sm uppercase px-6 py-3.5 rounded-full shadow-lg transition-all"
          >
            <span>Formulario de Contacto</span>
            <span className="w-8 h-8 rounded-full bg-brand-blue-700/10 text-brand-blue-700 flex items-center justify-center shrink-0 ml-3 group-hover:translate-x-1 transition-transform">
