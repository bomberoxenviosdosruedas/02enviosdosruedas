...
export default function CotizadorLowCostHero() {
  ...
  return (
    <section
      ...
      className="relative w-full overflow-hidden bg-brand-blue-500 text-white min-h-auto lg:min-h-[58vh] flex items-center pt-20 pb-6 sm:pt-24 sm:pb-10 lg:pt-28 lg:pb-14 border-b border-white/10"
    >
