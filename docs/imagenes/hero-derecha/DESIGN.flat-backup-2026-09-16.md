...
- **Dos carriles visuales, sin mezcla:** *fotografía real* (secciones, imagen inline del titular, zig-zag) e *ilustración flat vector minimal corporate* (Hero Card Media). Prohibido render 3D, clay o isométrico realista junto a la ilustración flat en la misma pantalla; los iconos Lucide de UI no cuentan como ilustración.
