...
*Estado operativo:* En curso · Listo para ejecución sincronizada  
...
| **6** | **Email de contacto público oficial** | BL-19, README, Contacto | **`contacto@enviosdosruedas.com.ar`** (en producción) / fallback **`matiascejas@enviosdosruedas.com`** | Unificar en un solo buzón corporativo con dominio propio; no exponer correos de desarrollo (`dev@...`). |
...
* **Track Comercial y Operativo:**
  ...
  - **Contenido:** Grabar y publicar el Reel 1: *"Así rendimos la plata del contrareembolso en el mismo día"* (PZ-05).
...
* **Track Comercial y Operativo:**
  ...
  - **Redes Sociales:** Publicar carrusel educativo en Instagram: *"Cómo funciona el contrareembolso en 4 pasos"* (PZ-07).
...
* **Track Comercial y Operativo:**
  - **Campaña de Depósito:** Publicar Reel 2: *"Tu stock en Friuli 1972: del clic al despacho en moto"* (PZ-13).
...
- **Disparador 1 (El más efectivo):** Inmediatamente después de rendir el efectivo de un contrareembolso:
  > *"Hola [Nombre], te transferimos la recaudación de los envíos de hoy ($[Monto]). Si te sirvió el servicio, ¿nos dejás una opinión breve en Google? Nos ayuda muchísimo a que otros comercios de Mar del Plata nos conozcan: [Enlace Corto GBP]. ¡Muchas gracias!"*
